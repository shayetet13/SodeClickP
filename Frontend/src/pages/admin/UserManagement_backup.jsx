...
const UserManagement = ({ onBack, filter = 'all' }) => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      console.log('🔍 API URL:', `${API_BASE_URL}/api/admin/users?page=${pagination.currentPage}&limit=${pagination.limit}&status=${statusFilter}`);
      
      const response = await fetch(`${API_BASE_URL}/api/admin/users?page=${pagination.currentPage}&limit=${pagination.limit}&status=${statusFilter}`, {
        headers: {
